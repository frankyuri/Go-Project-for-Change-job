...
func CreateCategory(c *gin.Context) {
	...
	if err := repositories.CreateCategory(&category); err != nil {
		c.JSON(http.StatusInternalServerError, utils.ErrorsResponse(http.StatusInternalServerError, "創建分類失敗: "+err.Error()))
...
func GetCategories(c *gin.Context) {
	...
	if err := repositories.GetCategories(&categories); err != nil {
		c.JSON(http.StatusInternalServerError, utils.ErrorsResponse(http.StatusInternalServerError, "查詢分類失敗: "+err.Error()))
		return
	}
...
func GetCategoryByID(c *gin.Context) {
	...
	if err := repositories.GetCategoryByID(id, &category); err != nil {
		c.JSON(http.StatusNotFound, utils.ErrorsResponse(http.StatusNotFound, "找不到分類"))
		return
	}
...
func UpdateCategory(c *gin.Context) {
	...
	if err := repositories.UpdateCategory(&category); err != nil {
		c.JSON(http.StatusInternalServerError, utils.ErrorsResponse(http.StatusInternalServerError, "更新分類失敗: "+err.Error()))
		return
	}
...
func DeleteCategory(c *gin.Context) {
	...
	if err := repositories.DeleteCategory(id); err != nil {
		c.JSON(http.StatusInternalServerError, utils.ErrorsResponse(http.StatusInternalServerError, "刪除分類失敗: "+err.Error()))
		return
	}
